...
<div class="cadastro">
    <div class="informacoes">
            ...
            <div class="rd">
                ...
                <input id="tamanho" name="tamanho" value="P" type="radio" required="required" value="${param.tamanho}">
                <label for="P">P</label>
                <input id="tamanho" name="tamanho" value="M" type="radio" required="required" value="${param.tamanho}">
                <label for="M">M</label>
                <input id="tamanho" name="tamanho" value="G" type="radio" required="required" value="${param.tamanho}">
                <label for="G">G</label>
                <input id="tamanho" name="tamanho" value="GG" type="radio" required="required" value="${param.tamanho}">
                <label for="GG">GG</label>
            </div>
            <p>Valor do produto:</p>
            <input id="valor_produto" name="valor_produto" required="required" value="${param.valor_produto}" type="number">
            <p hide>Quantidade</p>
